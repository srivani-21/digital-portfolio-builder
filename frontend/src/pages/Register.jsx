...
// The admin secret key — must match your backend .env
  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <p style={s.sub}>Start building your digital portfolio</p>
